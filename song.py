...
class Album:
    ...
    Attributes:
        ...
        artist: (Artist): The artist that created the album. If not specified,
    ...
    def __init__(self, name, year, artist=None):
        ...
        self.year = year
        if artist is None:
            self.artist = Album("Various Artists")
        else:
            self.artist = artist
    ...
    def add_song(self, song, position=None):
        ...
        Args:
            ...
            position (Optional[int]): A song will be added to that position
                in the track list - inserting it between other songs if necessary.
                Otherwise song added at end of list.
        """
        if position is None:
...
class Artist:
    ...
    Attributes:
        ...
        albums (List[Album]): List of the albums by this artist.
            ...
            It is not an exhaustive list of all albums published by the artist.
    ...
    def add_album(self, album):
        ...
        Args:
            album (Album): Album object to add to the list.
                If the album is already present, it will not be added again (Although yet to implement)
        """
